...
(function(){
    ...
    function formValidate($el){
        var $inputs = $el.find('input[type="text"]:enabled,input[type="password"]:enabled,textarea:enabled').trigger('keyup').filter('.invalid');
...
$(function(){
    ...
    }).on("click", ".user_logout", function() {
        $.ajax({
            url: "http://es2.laizhuan.com/module/offer1/User/logout",
            dataType: 'json',
            type: 'POST',
            data: {
